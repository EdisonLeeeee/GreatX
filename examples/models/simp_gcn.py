...
from graphwar.defense.model_level import SimPGCN
from graphwar.training import get_trainer
...
#                      Train your model                              #
# ================================================================== #
model = SimPGCN(num_feats, num_classes)
trainer = get_trainer(model)(model, device=device)
