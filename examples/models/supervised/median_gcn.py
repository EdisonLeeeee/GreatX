...
from greatx.nn.models import MedianGCN
...
model = MedianGCN(dataset.num_features, dataset.num_classes)
# use sample_median
# model = MedianGCN(dataset.num_features, dataset.num_classes, reduce='sample_median')
